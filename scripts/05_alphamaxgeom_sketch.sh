...
#   TEST_N=200 bash 05_alphamaxgeom_sketch.sh
#
# Full run — sketch all genomes (unset or 0 means "all"):
#   bash 05_alphamaxgeom_sketch.sh
# ==============================================================================
set -euo pipefail
...
# Override at the command line: TEST_N=500 bash 05_alphamaxgeom_sketch.sh
# ---------------------------------------------------------------------------
TEST_N="${TEST_N:-0}"
...
import json
stats = {
    "script":                "05_alphamaxgeom_sketch.sh",
    "algo":                  "${ALGO}",
    "kmer":                  ${KMER},
    "W":                     ${W},
    "alpha":                 ${ALPHA},
