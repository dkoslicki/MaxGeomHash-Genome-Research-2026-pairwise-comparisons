...
# genome pairs that passed the FracMinHash all-vs-all candidate filter
# (max_containment ≥ 0.001, from gtdb_pairwise_containment_thr0001.csv;
# see compute_fracminhash_candidates.sh).
#
